            ...
            <AppBar position="static" sx={{ bgcolor: 'black', boxShadow: '-0.5px 0.5px 2px grey' }}>
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        ...
                        >
                            {/* T-Booking */}
                            <img src={logo} style={{ height: "50px", width: "120px" }} alt='#' onClick={() => userHome('/')} />
                        </Typography>
                        ...
                        >
                            {/* T-Booking */}
                            <img src={logo} style={{ height: "50px", width: "120px" }} alt="#" />
                        </Typography>
                        ...
                        <Box sx={{ flexGrow: 0 }}>
                            <Tooltip title="Open settings">
                                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                    <Avatar alt="Avatar" src={localStorage.getItem('role') ==='admin'? adminAvatar : avatar} />
                                </IconButton>
                            </Tooltip>
                            <Menu
                                sx={{ mt: '45px' }}
