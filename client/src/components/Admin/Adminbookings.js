        ...
        <>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ background: 'aliceblue', width: '100%' }}>
                    ...
                    <AppBar position="static">
                        <Container maxWidth="xl">
                            <Toolbar disableGutters>
                                {active ? 
                                <FaOutdent style={{fontSize:'20px',marginRight:'5px'}} onClick={closed} id='home-btn'/>
                                    :
                                <FaOutdent style={{fontSize:'20px',marginRight:'5px',transform:"scaleX(-1)"}} onClick={expand} id='home-btn'/>
                                }
                                <Typography
                                 className='home'
                                    variant="h6"
                    ...
                    <Table bordered hover style={{ width: '98%', margin: '50px auto' }} className="users-table">
                        <thead>
                            <tr>
                                <th>Sno </th>
                                <th>First Name</th>
                    ...
                    {/* PAGINATION */}
                        ...
                        <Pagination style={{margin: 'auto 5px auto auto',float:'right' }}>
                            <Pagination.First />
                            <Pagination.Prev />
